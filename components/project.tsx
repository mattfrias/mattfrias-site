...
export default function Project({
  ...
  return (
    ...
    >
      <section className="relative max-w-[42rem] overflow-hidden rounded-lg border border-black/5 bg-gray-100 transition hover:bg-gray-200 sm:h-[21rem] sm:pr-8 sm:group-even:pl-8">
